...
public class PersonController {
	...
	@CrossOrigin(origins = {"http://localhost:8080", "http://localhost:3000",  "https://erudio.com.br"})
	...
	@PostMapping(value = "/v2",
			consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML }, 
			produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	@Operation(summary = "Adds a new PersonV2", description = "Adds a new Person by passing in a JSON, XML or YML representation of the person in V2!",
	tags = {"People"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200",
			content = @Content(schema = @Schema(implementation = PersonVO.class))
